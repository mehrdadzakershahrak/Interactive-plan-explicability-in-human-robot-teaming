(define (problem rover-1)
     ...
     (:init
        (room room10) (room room2) (room room14) (room room1)
        (room dummy-room)
        ...
        (is-in room10 loc10)(is-in room2 loc2)(is-in room14 loc14)(is-in room1 loc1)
        (rover rover1)
        (at rover1 loc18)

        (visited dummy-room)
        (room-prec dummy-room room10)
        (room-prec room10 room2)
        (room-prec room2 room14)
        (room-prec room14 room1)
        (human-acted)
