(define (problem rover-1)
     ...
     (:init
        (room room10) (room room6) (room room11) (room room9)
        (room dummy-room)
        ...
        (is-in room10 loc10)(is-in room6 loc6)(is-in room11 loc11)(is-in room9 loc9)
        (rover rover1)
        (at rover1 loc18)

        (visited dummy-room)
        (room-prec dummy-room room10)
        (room-prec room10 room6)
        (room-prec room6 room11)
        (room-prec room11 room9)
        (human-acted)
