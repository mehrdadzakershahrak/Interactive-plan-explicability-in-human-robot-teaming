(define (problem rover-1)
     ...
     (:init
        (room room7) (room room11) (room room4) (room room6) 
        (room dummy-room)
        ...
        (is-in room7 loc7)(is-in room11 loc11)(is-in room4 loc4)(is-in room6 loc6)
