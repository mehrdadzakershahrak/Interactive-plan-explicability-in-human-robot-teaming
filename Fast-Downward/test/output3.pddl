(define (problem rover-1)
     ...
     (:init
        (room room11) (room room4) (room room2) (room room6) 
        (room dummy-room)
        ...
        (is-in room11 loc11)(is-in room4 loc4)(is-in room2 loc2)(is-in room6 loc6)
        ...
        (room-prec room11 room4)
        (room-prec room4 room2)
        (room-prec room2 room6)
        (human-acted)
