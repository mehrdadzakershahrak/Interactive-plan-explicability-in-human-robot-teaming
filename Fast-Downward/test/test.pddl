(define (problem rover-1)
     ...
     (:init
        (room room4) (room room5) (room room1) (room room3)
        (room dummy-room)
        ...
        (is-in room4 loc4)(is-in room5 loc5)(is-in room1 loc1)(is-in room3 loc3)
        (rover rover1)
        (at rover1 loc13)
        (visited dummy-room)
        ...
        (room-prec room4 room5)
        (room-prec room4 room1)
        (room-prec room4 room3)
        (room-prec room5 room1)
