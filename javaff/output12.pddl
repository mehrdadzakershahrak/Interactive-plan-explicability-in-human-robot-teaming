(define (problem rover-1)
     ...
     (:init
        ...
        (open loc1) (open loc2) (open loc3) (open loc4) (open loc5) (open loc6) (open loc7) (open loc8) (open loc9) (open loc10) (open loc11) (open loc12) (open loc13) (open loc14) (open loc15) (open loc16) (open loc17) (open loc18) (open loc19) (open loc20) (open loc21) (open loc22) (open loc24) (open loc25) (open loc27) (open loc28) (open loc29) (open loc30) (open loc31) (open loc33) (open loc34) (open loc35) (open loc36)
        ...
        (can-move loc14 loc13)(can-move loc15 loc14)(can-move loc16 loc15)(can-move loc17 loc16)(can-move loc18 loc17) (visible loc13 loc14) (visible loc14 loc13) (visible loc14 loc15) (visible loc15 loc14) (visible loc15 loc16) (visible loc16 loc15) (visible loc16 loc17) (visible loc17 loc16) (visible loc17 loc18) (visible loc18 loc17)
        ...
        (can-move loc26 loc25)(can-move loc27 loc26)(can-move loc28 loc27)(can-move loc29 loc28)(can-move loc30 loc29) (visible loc26 loc25) (visible loc26 loc27) (visible loc27 loc28) (visible loc28 loc27) (visible loc28 loc29) (visible loc29 loc28) (visible loc29 loc30) (visible loc30 loc29)

        (can-move loc31 loc32)(can-move loc32 loc33)(can-move loc33 loc34)(can-move loc34 loc35)(can-move loc35 loc36)

        (can-move loc32 loc31)(can-move loc33 loc32)(can-move loc34 loc33)(can-move loc35 loc34)(can-move loc36 loc35) (visible loc32 loc31) (visible loc32 loc33) (visible loc33 loc34) (visible loc34 loc33) (visible loc34 loc35) (visible loc35 loc34) (visible loc35 loc36) (visible loc36 loc35)

        (can-move loc25 loc31)(can-move loc31 loc25)

        (visible loc25 loc31)(visible loc31 loc25)

        (can-move loc14 loc20)(can-move loc20 loc14)(can-move loc20 loc26)(can-move loc26 loc20)(can-move loc26 loc32)(can-move loc32 loc26)

        (visible loc14 loc20)(visible loc20 loc14)(visible loc26 loc20)

        (can-move loc27 loc33)(can-move loc33 loc27)

        (visible loc27 loc33)(visible loc33 loc27)

        (can-move loc4 loc10)(can-move loc10 loc4)(can-move loc10 loc16)(can-move loc16 loc10)(can-move loc28 loc34)(can-move loc34 loc28)

        (visible loc4 loc10)(visible loc10 loc4)(visible loc10 loc16)(visible loc16 loc10)(visible loc28 loc34)(visible loc34 loc28)
        ...
        (visible loc5 loc11)(visible loc11 loc5)(visible loc11 loc17)(visible loc17 loc11)(visible loc23 loc17)(visible loc23 loc29)(visible loc29 loc35)(visible loc35 loc29)
        ...
        (is-in room1 loc12)(is-in room2 loc14)(is-in room3 loc31)(is-in room4 loc35)

        (rover rover1)

        (at rover1 loc1)

        (is-in obstacle1 loc23) (is-in obstacle2 loc26) (is-in obstacle3 loc32)
