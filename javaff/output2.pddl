(define (problem rover-1)
     ...
     (:init
        ...
        (can-move loc10 loc9) (visible loc9 loc10) (visible loc10 loc9)

        (can-move loc15 loc16)(can-move loc16 loc17)(can-move loc17 loc18)

        (can-move loc16 loc15)(can-move loc17 loc16)(can-move loc18 loc17) (visible loc15 loc16) (visible loc16 loc15) (visible loc16 loc17) (visible loc17 loc16) (visible loc17 loc18) (visible loc18 loc17)

        (can-move loc23 loc24)

        (can-move loc24 loc23) (visible loc23 loc24) (visible loc24 loc23)

        (can-move loc28 loc29)(can-move loc29 loc30)

        (can-move loc29 loc28)(can-move loc30 loc29) (visible loc28 loc29) (visible loc29 loc28) (visible loc29 loc30) (visible loc30 loc29)
        ...
        (can-move loc1 loc7)(can-move loc7 loc1)(can-move loc7 loc13)(can-move loc13 loc7)(can-move loc13 loc19)(can-move loc19 loc13)

        (visible loc1 loc7)(visible loc7 loc1)(visible loc7 loc13)(visible loc13 loc7)(visible loc13 loc19)(visible loc19 loc13)

        (can-move loc26 loc32)(can-move loc32 loc26)

        (visible loc26 loc32)(visible loc32 loc26)
        ...
        (visible loc4 loc10)(visible loc10 loc16)(visible loc16 loc10)(visible loc28 loc34)(visible loc34 loc28)
        ...
        (visible loc12 loc6)(visible loc12 loc18)(visible loc18 loc24)(visible loc24 loc18)(visible loc24 loc30)(visible loc30 loc24)(visible loc30 loc36)(visible loc36 loc30)



        (is-in room1 loc6) (is-in room2 loc10) (is-in room3 loc13) (is-in room4 loc24)

        (rover rover1)

        (at rover1 loc31)

        (is-in obstacle1 loc4) (is-in obstacle2 loc12)
