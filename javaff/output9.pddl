(define (problem rover-1)
     ...
     (:init
        ...
        (can-move loc8 loc7)(can-move loc9 loc8)(can-move loc12 loc11) (visible loc7 loc8) (visible loc8 loc7) (visible loc9 loc8) (visible loc11 loc12) (visible loc12 loc11)
        ...
        (can-move loc29 loc30)

        (can-move loc30 loc29) (visible loc29 loc30) (visible loc30 loc29)
        ...
        (can-move loc2 loc8)(can-move loc8 loc2)

        (visible loc2 loc8)(visible loc8 loc2)

        (can-move loc3 loc9)(can-move loc9 loc3)(can-move loc21 loc27)(can-move loc27 loc21)(can-move loc27 loc33)(can-move loc33 loc27)

        (visible loc9 loc3)(visible loc21 loc27)(visible loc27 loc21)(visible loc27 loc33)(visible loc33 loc27)





        (can-move loc5 loc11)(can-move loc11 loc5)(can-move loc11 loc17)(can-move loc17 loc11)(can-move loc29 loc35)(can-move loc35 loc29)

        (visible loc5 loc11)(visible loc11 loc5)(visible loc11 loc17)(visible loc17 loc11)(visible loc29 loc35)(visible loc35 loc29)
        ...
        (is-in room1 loc3)(is-in room2 loc7)(is-in room3 loc12)(is-in room4 loc27)

        (rover rover1)

        (at rover1 loc36)

        (is-in obstacle1 loc9)
