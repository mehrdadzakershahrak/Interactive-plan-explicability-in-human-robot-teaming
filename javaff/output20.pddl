(define (problem rover-1)
     ...
     (:init
        ...
        (can-move loc11 loc10)(can-move loc12 loc11) (visible loc10 loc11) (visible loc11 loc12) (visible loc12 loc11)
        ...
        (can-move loc20 loc19)(can-move loc21 loc20)(can-move loc22 loc21)(can-move loc23 loc22) (visible loc19 loc20) (visible loc20 loc19) (visible loc20 loc21) (visible loc21 loc20) (visible loc21 loc22) (visible loc22 loc21) (visible loc22 loc23) (visible loc23 loc22)
        ...
        (can-move loc32 loc33)(can-move loc33 loc34)(can-move loc34 loc35)(can-move loc35 loc36)

        (can-move loc33 loc32)(can-move loc34 loc33)(can-move loc35 loc34)(can-move loc36 loc35) (visible loc32 loc33) (visible loc33 loc34) (visible loc34 loc33) (visible loc35 loc34) (visible loc35 loc36)

        (can-move loc19 loc25)(can-move loc25 loc19)

        (visible loc19 loc25)(visible loc25 loc19)
        ...
        (visible loc2 loc8)(visible loc8 loc2)(visible loc20 loc26)(visible loc26 loc20)(visible loc32 loc26)

        (can-move loc21 loc27)(can-move loc27 loc21)(can-move loc27 loc33)(can-move loc33 loc27)

        (visible loc21 loc27)(visible loc27 loc21)(visible loc27 loc33)(visible loc33 loc27)
        ...
        (visible loc10 loc4)(visible loc22 loc28)(visible loc28 loc22)(visible loc28 loc34)(visible loc34 loc28)
        ...
        (is-in room1 loc6)(is-in room2 loc20)(is-in room3 loc30)(is-in room4 loc33)

        (rover rover1)

        (at rover1 loc1)

        (is-in obstacle1 loc10) (is-in obstacle2 loc32) (is-in obstacle3 loc35)
