(define (problem rover-1)
     ...
     (:init
        ...
        (can-move loc6 loc5) (visible loc5 loc6) (visible loc6 loc5)
        ...
        (can-move loc32 loc31)(can-move loc33 loc32)(can-move loc36 loc35) (visible loc32 loc31) (visible loc32 loc33) (visible loc35 loc36) (visible loc36 loc35)
        ...
        (is-in room1 loc3)(is-in room2 loc6)(is-in room3 loc31)(is-in room4 loc35)

        (rover rover1)

        (at rover1 loc1)

        (is-in obstacle1 loc32) (is-in obstacle2 loc16)
