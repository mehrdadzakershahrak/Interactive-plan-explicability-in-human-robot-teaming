(define (problem rover-1)
     ...
     (:init
        (room room3) (room room2) (room room1) (room room4)
        (room dummy-room)
        ...
        (can-move loc11 loc12) (can-move loc12 loc13) (can-move loc13 loc14) (can-move loc15 loc16) 
	(can-move loc16 loc17) (can-move loc17 loc18) (can-move loc18 loc19) (can-move loc19 loc20)
        ...
        (can-move loc13 loc18) (can-move loc14 loc19) (can-move loc15 loc20) (can-move loc6 loc1)
	(can-move loc7 loc2) (can-move loc8 loc3) (can-move loc9 loc4) (can-move loc10 loc5)
	(can-move loc11 loc6) (can-move loc12 loc7) (can-move loc13 loc8) (can-move loc14 loc9)
	(can-move loc15 loc10) (can-move loc16 loc11) (can-move loc17 loc12) (can-move loc18 loc13)
	(can-move loc19 loc14) (can-move loc20 loc15)
        ...
        (visible loc11 loc12) (visible loc12 loc13) (visible loc13 loc14) (visible loc15 loc16)
	(visible loc16 loc17) (visible loc17 loc18) (visible loc18 loc19) (visible loc19 loc20)
        ...
        (visible loc13 loc18) (visible loc14 loc19) (visible loc15 loc20) (visible loc6 loc1)
	(visible loc7 loc2) (visible loc8 loc3) (visible loc9 loc4) (visible loc10 loc5)
	(visible loc11 loc6) (visible loc12 loc7) (visible loc13 loc8) (visible loc14 loc9)
	(visible loc15 loc10) (visible loc16 loc11) (visible loc17 loc12) (visible loc18 loc13)
	(visible loc19 loc14) (visible loc20 loc15)

        (is-in room3 loc3)(is-in room2 loc2)(is-in room1 loc1)(is-in room4 loc4)
        (rover rover1)
        (at rover1 loc13)
        ...
        (room-prec room3 room1)
        (room-prec room3 room4)
        (room-prec room2 room1)
        (room-prec room2 room4)
        (room-prec room1 room4)
        (human-acted)
