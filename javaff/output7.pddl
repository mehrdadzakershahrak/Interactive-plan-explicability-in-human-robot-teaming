(define (problem rover-1)
     ...
     (:init
        ...
        (can-move loc8 loc7)(can-move loc9 loc8)(can-move loc12 loc11) (visible loc7 loc8) (visible loc8 loc7) (visible loc8 loc9) (visible loc9 loc8) (visible loc11 loc12) (visible loc12 loc11)
        ...
        (can-move loc1 loc7)(can-move loc7 loc1)

        (visible loc1 loc7)(visible loc7 loc1)

        (can-move loc2 loc8)(can-move loc8 loc2)(can-move loc8 loc14)(can-move loc14 loc8)(can-move loc14 loc20)(can-move loc20 loc14)

        (visible loc2 loc8)(visible loc8 loc2)(visible loc14 loc8)(visible loc14 loc20)

        (can-move loc3 loc9)(can-move loc9 loc3)

        (visible loc3 loc9)(visible loc9 loc3)

        (can-move loc16 loc22)(can-move loc22 loc16)

        (visible loc16 loc22)(visible loc22 loc16)
        ...
        (visible loc5 loc11)(visible loc11 loc5)(visible loc23 loc29)(visible loc29 loc23)(visible loc29 loc35)(visible loc35 loc29)
        ...
        (is-in room1 loc20)(is-in room2 loc24)(is-in room3 loc31)(is-in room4 loc36)

        (rover rover1)

        (at rover1 loc6)

        (is-in obstacle1 loc14) (is-in obstacle2 loc34)
