(define (problem rover-1)
     ...
     (:init
        ...
        (can-move loc8 loc9)(can-move loc11 loc12)

        (can-move loc9 loc8)(can-move loc12 loc11) (visible loc11 loc12) (visible loc12 loc11)

        (can-move loc13 loc14)(can-move loc14 loc15)

        (can-move loc14 loc13)(can-move loc15 loc14) (visible loc13 loc14) (visible loc14 loc13) (visible loc14 loc15) (visible loc15 loc14)
        ...
        (can-move loc31 loc32)

        (can-move loc32 loc31) (visible loc31 loc32) (visible loc32 loc31)
        ...
        (can-move loc8 loc14)(can-move loc14 loc8)(can-move loc14 loc20)(can-move loc20 loc14)

        (visible loc8 loc14)(visible loc14 loc20)(visible loc20 loc14)

        (can-move loc3 loc9)(can-move loc9 loc3)(can-move loc9 loc15)(can-move loc15 loc9)(can-move loc15 loc21)(can-move loc21 loc15)

        (visible loc9 loc3)(visible loc9 loc15)(visible loc15 loc21)(visible loc21 loc15)





        (can-move loc5 loc11)(can-move loc11 loc5)(can-move loc11 loc17)(can-move loc17 loc11)(can-move loc17 loc23)(can-move loc23 loc17)(can-move loc23 loc29)(can-move loc29 loc23)

        (visible loc5 loc11)(visible loc11 loc5)(visible loc11 loc17)(visible loc17 loc11)(visible loc17 loc23)(visible loc23 loc17)(visible loc23 loc29)(visible loc29 loc23)

        (can-move loc6 loc12)(can-move loc12 loc6)(can-move loc24 loc30)(can-move loc30 loc24)(can-move loc30 loc36)(can-move loc36 loc30)

        (visible loc6 loc12)(visible loc12 loc6)(visible loc24 loc30)(visible loc30 loc24)(visible loc30 loc36)(visible loc36 loc30)



        (is-in room1 loc3)(is-in room2 loc13)(is-in room3 loc24)(is-in room4 loc32)

        (rover rover1)

        (at rover1 loc6)

        (is-in obstacle1 loc8) (is-in obstacle2 loc9)
