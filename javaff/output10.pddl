(define (problem rover-1)
     ...
     (:init
        ...
        (open loc1) (open loc2) (open loc3) (open loc4) (open loc6) (open loc7) (open loc8) (open loc9) (open loc10) (open loc11) (open loc12) (open loc13) (open loc14) (open loc15) (open loc17) (open loc19) (open loc20) (open loc21) (open loc22) (open loc23) (open loc24) (open loc26) (open loc27) (open loc28) (open loc29) (open loc30) (open loc31) (open loc32) (open loc33) (open loc34) (open loc35) (open loc36)
        ...
        (can-move loc7 loc8)(can-move loc8 loc9)(can-move loc9 loc10)

        (can-move loc8 loc7)(can-move loc9 loc8)(can-move loc10 loc9) (visible loc7 loc8) (visible loc8 loc7) (visible loc8 loc9) (visible loc9 loc8) (visible loc9 loc10) (visible loc10 loc9)

        (can-move loc15 loc16)

        (can-move loc16 loc15) (visible loc16 loc15)

        (can-move loc19 loc20)(can-move loc20 loc21)(can-move loc21 loc22)

        (can-move loc20 loc19)(can-move loc21 loc20)(can-move loc22 loc21) (visible loc19 loc20) (visible loc20 loc19) (visible loc20 loc21) (visible loc21 loc20) (visible loc21 loc22) (visible loc22 loc21)

        (can-move loc25 loc26)

        (can-move loc26 loc25) (visible loc25 loc26)

        (can-move loc32 loc33)(can-move loc33 loc34)

        (can-move loc33 loc32)(can-move loc34 loc33) (visible loc32 loc33) (visible loc33 loc32) (visible loc33 loc34) (visible loc34 loc33)

        (can-move loc1 loc7)(can-move loc7 loc1)(can-move loc7 loc13)(can-move loc13 loc7)(can-move loc13 loc19)(can-move loc19 loc13)(can-move loc19 loc25)(can-move loc25 loc19)

        (visible loc1 loc7)(visible loc7 loc1)(visible loc7 loc13)(visible loc13 loc7)(visible loc13 loc19)(visible loc19 loc13)(visible loc25 loc19)
        ...
        (visible loc2 loc8)(visible loc8 loc2)(visible loc20 loc26)(visible loc26 loc20)(visible loc26 loc32)(visible loc32 loc26)
        ...
        (visible loc6 loc12)(visible loc12 loc6)(visible loc18 loc12)(visible loc18 loc24)(visible loc24 loc30)(visible loc30 loc24)(visible loc30 loc36)(visible loc36 loc30)



        (is-in room1 loc3)(is-in room2 loc13)(is-in room3 loc32)(is-in room4 loc34)

        (rover rover1)

        (at rover1 loc36)

        (is-in obstacle1 loc5) (is-in obstacle2 loc18) (is-in obstacle3 loc16) (is-in obstacle4 loc25)
