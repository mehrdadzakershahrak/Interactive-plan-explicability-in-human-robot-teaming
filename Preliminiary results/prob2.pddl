...
(define (problem rover-1)
     ...
     (:init
        (room room3) (room room10) (room room13) (room room15) 
        (room dummy-room)
        (obstacle obstacle12) (obstacle obstacle13) (obstacle obstacle17) (obstacle obstacle7) (obstacle obstacle19) (obstacle obstacle15) (obstacle obstacle1) 
       ...
       (can-move loc10 loc5)(can-move loc15 loc10)(can-move loc20 loc15) (visible loc5 loc10)
        ...
        (is-in room3 loc3)(is-in room10 loc10)(is-in room13 loc13)(is-in room15 loc15)
        (rover rover1)
        (at rover1 loc19)
...
(define (problem rover-1)
     ...
     (:objects
         room3 room10 room13 room15
         dummy-room

         obstacle12 obstacle17 obstacle7 obstacle19 obstacle15 obstacle1
     ...
     (:init
        (room room15) (room room3) (room room10) (room room13) 
        (room dummy-room)
        (obstacle obstacle12) (obstacle obstacle13) (obstacle obstacle17) (obstacle obstacle7) (obstacle obstacle19) (obstacle obstacle15) (obstacle obstacle1) 
       ...
       (can-move loc10 loc5)(can-move loc15 loc10)(can-move loc20 loc15) (visible loc5 loc10)
        ...
        (is-in room15 loc15)(is-in room3 loc3)(is-in room10 loc10)(is-in room13 loc13)
        (rover rover1)
        (at rover1 loc16)

        (is-in obsctacle12 loc12) (is-in obsctacle17 loc17) (is-in obsctacle7 loc7) (is-in obsctacle19 loc19) (is-in obsctacle15 loc15) (is-in obsctacle1 loc1) 
...
(define (problem rover-1)
     ...
     (:init
        (room room10) (room room13) (room room14) (room room3) 
        (room dummy-room)
        (obstacle obstacle12) (obstacle obstacle13) (obstacle obstacle17) (obstacle obstacle7) (obstacle obstacle19) (obstacle obstacle15) (obstacle obstacle1) 
       ...
       (can-move loc10 loc5)(can-move loc15 loc10)(can-move loc20 loc15) (visible loc5 loc10)
        ...
        (is-in room10 loc10)(is-in room13 loc13)(is-in room14 loc14)(is-in room3 loc3)
        (rover rover1)
        (at rover1 loc17)
...
(define (problem rover-1)
     ...
     (:init
        (room room3) (room room14) (room room15) (room room13) 
        (room dummy-room)
        (obstacle obstacle12) (obstacle obstacle13) (obstacle obstacle17) (obstacle obstacle7) (obstacle obstacle19) (obstacle obstacle15) (obstacle obstacle1) 
       ...
       (can-move loc10 loc5)(can-move loc15 loc10)(can-move loc20 loc15) (visible loc5 loc10) (visible loc10 loc15) (visible loc15 loc20)
        ...
        (is-in room3 loc3)(is-in room14 loc14)(is-in room15 loc15)(is-in room13 loc13)
        (rover rover1)
        (at rover1 loc17)
